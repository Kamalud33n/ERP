...
# Employee → own assigned assets (must come before /{asset_id})
...
# ── Maintenance (must come before /{asset_id}) ──────────
...
# ── Export Reports (must come before /{asset_id}) ───────
